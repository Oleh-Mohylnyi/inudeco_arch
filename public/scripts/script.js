...
const developerKey = 'AIzaSyCGx9qlzX3MWuvAQTK_zlTtkVjfMAUMIuM';
const clientId = '1095236998911-5tnjrm006ot090nuq1k42ontga5khqqp.apps.googleusercontent.com';
...
async function pickerCallback(_data) {
    ...
    if (_data[google.picker.Response.DOCUMENTS]) {
        console.log(`Ответ от сервера 92: ${resultFinal}`);
        const xhrArray = _data[google.picker.Response.DOCUMENTS].map(async doc => {
            ...
            try {
                ...
                console.log(`Ответ от сервера: ${resultFinal}`);
